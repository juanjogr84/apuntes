...
//		animal2 = new Animal(2, false, "Calamar"); ***NO LO TENGO***
		...
		zoo.add(perro1);
//		zoo.add(animal1); ***NO LO TENGO***
		zoo.add(gato1);
//		zoo.add(animal2); ***NO LO TENGO***
		zoo.add(perro2);
		zoo.add(gato2);
